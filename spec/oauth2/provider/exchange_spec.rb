...
describe OAuth2::Provider::Exchange do
  ...
  shared_examples_for "validates required parameters" do
    describe "missing grant_type" do
      ...
      it "is invalid" do
        exchange.error.should be == "invalid_request"
        exchange.error_description.should be == "Missing required parameter client_id"
      end
    end
    ...
    describe "with an unknown grant type" do
      ...
      it "is invalid" do
        exchange.error.should be == "unsupported_grant_type"
        exchange.error_description.should be == "The grant type unknown is not recognized"
      end
    end
    ...
    describe "with an unknown client_id" do
      ...
      it "is invalid" do
        exchange.error.should be == "invalid_client"
        exchange.error_description.should be == "Unknown client ID unknown"
      end
    end
    ...
    describe "missing client_secret" do
      ...
      it "is invalid" do
        exchange.error.should be == "invalid_request"
        exchange.error_description.should be == "Missing required parameter client_secret"
      end
    end
    ...
    describe "with a mismatched client_secret" do
      ...
      it "is invalid" do
        exchange.error.should be == "invalid_client"
        exchange.error_description.should be == "Parameter client_secret does not match"
      end
    end
    ...
    describe "with scopes not covered by the authorization code" do
      ...
      it "is invalid" do
        exchange.error.should be == 'invalid_scope'
        exchange.error_description.should be == 'The request scope was never granted by the user'
      end
    end
  end
  ...
  describe "using authorization_code grant type" do
    ...
    describe "missing redirect_uri" do
      ...
      it "is invalid" do
        exchange.error.should be == "invalid_request"
        exchange.error_description.should be == "Missing required parameter redirect_uri"
      end
    end
    ...
    describe "with a mismatched redirect_uri" do
      ...
      it "is invalid" do
        exchange.error.should be == "redirect_uri_mismatch"
        exchange.error_description.should be == "Parameter redirect_uri does not match registered URI"
      end
    ...
    describe "missing code" do
      ...
      it "is invalid" do
        exchange.error.should be == "invalid_request"
        exchange.error_description.should be == "Missing required parameter code"
      end
    end
    ...
    describe "with an unknown code" do
      ...
      it "is invalid" do
        exchange.error.should be == "invalid_grant"
        exchange.error_description.should be == "The access grant you supplied is invalid"
      end
    end
  ...
  describe "using password grant type" do
    ...
    describe "missing username" do
      ...
      it "is invalid" do
        exchange.error.should be == 'invalid_request'
        exchange.error_description.should be == 'Missing required parameter username'
      end
    end
    ...
    describe "missing password" do
      ...
      it "is invalid" do
        exchange.error.should be == 'invalid_request'
        exchange.error_description.should be == 'Missing required parameter password'
      end
    end
  ...
  describe "using assertion grant type" do
    ...
    describe "missing assertion_type" do
      ...
      it "is invalid" do
        exchange.error.should be == 'invalid_request'
        exchange.error_description.should be == 'Missing required parameter assertion_type'
      end
    end
    ...
    describe "with a non-URI assertion_type" do
      ...
      it "is invalid" do
        exchange.error.should be == 'invalid_request'
        exchange.error_description.should be == 'Parameter assertion_type must be an absolute URI'
      end
    end
    ...
    describe "missing assertion" do
      ...
      it "is invalid" do
        exchange.error.should be == 'invalid_request'
        exchange.error_description.should be == 'Missing required parameter assertion'
      end
    end
    ...
    describe "with an unrecognized assertion_type" do
      ...
      it "is invalid" do
        exchange.error.should be == 'unauthorized_client'
        exchange.error_description.should be == 'Client cannot use the given assertion type'
      end
    end
